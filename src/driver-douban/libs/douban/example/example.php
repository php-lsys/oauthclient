...
$appConfig = array(
            // 必选参数，豆瓣应用public key。
            'client_id' => '001bb05de0ce514300531119a26af3c9',
            // 必选参数，豆瓣应用secret key。
            'secret' => '6891594325e875b4',
            // 必选参数，用户授权后的回调链接。
            'redirect_uri' => 'http://www.kankanshi.com/douban/example/example.php',
...
print_r($douban->api('User.me.GET')->makeRequest());
